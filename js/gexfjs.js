    ...
    var GexfJS = {
        ...
        i18n: {
            ...
            "en": {
                ...
                "nodeAttr": "Attributes",
                "nodes": "Nodes",
                "inLinks": "Канали, які постили цей канал:",
                "outLinks": "Канали, які постив цей канал:",
    ...
    function traceArc(ctx, source, target, arrow_size, draw_arrow) {
        ...
        if (GexfJS.params.curvedEdges) {
            ...
            if (draw_arrow) {
                ...
                drawArrowhead(ctx, target.x, target.y, findAngle(0, 0, x_prime_middle, y_prime_middle), arrow_size, arrow_size);
            }
        } else {
